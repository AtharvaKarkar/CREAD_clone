...
window.addEventListener("scroll", () => {
  ...
  const scrollPosition = window.scrollY; //will get the current scroll position of the window and assigns it to the 'scrollPosition' constant.

  const section4OffsetTop = section4.offsetTop;

  const section4Height = section4.clientHeight;

  // checking if the scrollPostion is within the range of section4 elements top offset and height.
